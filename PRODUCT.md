...
- First launch is a short, skippable path: understand the product, choose a Primary and optional Secondary CLI, test the Primary, confirm the global listening shortcut, then enter Arco.
