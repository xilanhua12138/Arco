...
- **Idle Current:** whenever capture is off, Current is one quiet launch surface centered on the waveform, `Start listening` heading, and one large CTA. The Agent workspace appears only after capture begins and there is live meeting context to discuss.
