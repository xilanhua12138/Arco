...
private struct ArcoLocalizationContractTests {
    ...
    static func main() throws {
        ...
        try expect(englishKeys.count == 768, "English must include all current product copy")
        try expect(chineseKeys.count == 768, "zh-CN must include all current product copy")
