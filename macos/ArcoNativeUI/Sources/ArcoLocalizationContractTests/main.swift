...
private struct ArcoLocalizationContractTests {
    ...
    static func main() throws {
        ...
        try expect(englishKeys.count == 769, "English must include all current product copy")
        try expect(chineseKeys.count == 769, "zh-CN must include all current product copy")
