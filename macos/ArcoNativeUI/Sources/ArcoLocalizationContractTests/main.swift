...
private struct ArcoLocalizationContractTests {
    ...
    static func main() throws {
        ...
        try expect(englishKeys.count == 678, "English must include all current product copy")
        try expect(chineseKeys.count == 678, "zh-CN must include all current product copy")
