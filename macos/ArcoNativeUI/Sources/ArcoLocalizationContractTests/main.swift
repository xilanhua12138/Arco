...
private struct ArcoLocalizationContractTests {
    ...
    static func main() throws {
        ...
        try expect(englishKeys.count == 758, "English must include all current product copy")
        try expect(chineseKeys.count == 758, "zh-CN must include all current product copy")
